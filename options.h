...
const unsigned int BOX_WIDTH  = 44; //49;	// At 300dpi the box width in pixels
const unsigned int BOX_HEIGHT = 16; //18;	// At 300dpi the box height in pixels (should be smaller than width)
const unsigned int MAX_ERROR = 10;	// Max error in pixels (e.g. box_width plus or minus error)
const unsigned int DIAGONAL = 47; //53;	// ceil(sqrt(box_width^2+box_height^2)) plus or minus error
